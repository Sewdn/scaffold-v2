...
async function scaffoldOneApp(
  appName: string,
  appType: AppType,
  options: { withUi?: boolean; nonInteractive?: boolean; exampleCommand?: boolean; exampleService?: boolean },
  ...
  const runContext = { projectName, projectDir, appName: dirName, appType, appDir, patchScriptPath };
  const appTypeContext = { projectName, appName: dirName, appDir, projectDir, appType, patchScriptPath };
