#!/usr/bin/env node
/**
 * Cursor hook: runs oxfmt after Agent or Tab edits a file.
 * Input (stdin): JSON with file_path and edits from afterFileEdit/afterTabFileEdit.
 * Exit 0: success (or skip). Exit 2: block. Other: fail-open (action proceeds).
 */
