...
**Description:** REST API (Elysia.js) with Swagger, CORS. Build REST APIs with Elysia.
...
- **Hono:** Lighter; multi-runtime; similar API. See [api-hono](../api-hono).
- **Fastify:** More mature; plugin ecosystem; Node.js focused. See [api-fastify](../api-fastify).
